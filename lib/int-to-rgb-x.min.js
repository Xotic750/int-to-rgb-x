 ...
 * @module int-to-rgb-x
 */
"use strict";var toUint24=_dereq_("to-uint-24-x"),padStart=_dereq_("string-pad-start-x");module.exports=function intToRGB(i){return"#"+padStart(toUint24(i).toString(16),6,"0").toUpperCase()}},{"string-pad-start-x":19,"to-uint-24-x":26}],2:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":7,"to-number-x":22}],14:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],15:[function(_dereq_,module,exports){/**
 ...
 * @module modulo-x
 */
"use strict";module.exports=function modulo(dividend,divisor){var remain=dividend%divisor;return Math.floor(remain>=0?remain:remain+divisor)}},{}],16:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":14,"to-integer-x":20}],22:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":12,"validate.io-undefined":30}],25:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":11}],26:[function(_dereq_,module,exports){/**
 ...
 * @module to-uint-24-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),modulo=_dereq_("modulo-x"),sign=_dereq_("math-sign-x"),numberIsFinite=_dereq_("is-finite-x");module.exports=function toUint24(argument){var number=toNumber(argument);return 0===number||!1===numberIsFinite(number)?0:modulo(sign(number)*Math.floor(Math.abs(number)),16777216)}},{"is-finite-x":5,"math-sign-x":13,"modulo-x":15,"to-number-x":22}],27:[function(_dereq_,module,exports){/**
 ...
 * @module trim-left-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reLeft=new RegExp("^["+_dereq_("white-space-x").string+"]+");module.exports=function trimLeft(string){return $toString(string).replace(reLeft,"")}},{"to-string-x":25,"white-space-x":31}],28:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reRight=new RegExp("["+_dereq_("white-space-x").string+"]+$");module.exports=function trimRight(string){return $toString(string).replace(reRight,"")}},{"to-string-x":25,"white-space-x":31}],29:[function(_dereq_,module,exports){/**
