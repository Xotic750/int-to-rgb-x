 ...
 * @module modulo-x
 */
"use strict";module.exports=function(dividend,divisor){var remain=dividend%divisor;return Math.floor(remain>=0?remain:remain+divisor)}},{}],21:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function ToLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":19,"to-integer-x":27}],29:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":17,"validate.io-undefined":37}],32:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":16}],33:[function(_dereq_,module,exports){/**
 ...
 * @module to-uint-24-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),modulo=_dereq_("modulo-x"),sign=_dereq_("math-sign-x"),numberIsFinite=_dereq_("is-finite-x");module.exports=function toUint24(argument){var number=toNumber(argument);if(number!==number||0===number||!numberIsFinite(number))return 0;var integer=sign(number)*Math.floor(Math.abs(number));return modulo(integer,16777216)}},{"is-finite-x":7,"math-sign-x":18,"modulo-x":20,"to-number-x":29}],34:[function(_dereq_,module,exports){/**
 ...
 * @module trim-left-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reLeft=new RegExp("^["+_dereq_("white-space-x").string+"]+");module.exports=function trimLeft(string){return $toString(string).replace(reLeft,"")}},{"to-string-x":32,"white-space-x":38}],35:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reRight=new RegExp("["+_dereq_("white-space-x").string+"]+$");module.exports=function trimRight(string){return $toString(string).replace(reRight,"")}},{"to-string-x":32,"white-space-x":38}],36:[function(_dereq_,module,exports){/**
