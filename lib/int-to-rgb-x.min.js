 ...
 * @module int-to-rgb-x
 */
"use strict";var toUint24=_dereq_("to-uint-24-x"),padStart=_dereq_("string-pad-start-x"),cachedCtrs=_dereq_("cached-constructors-x"),numbertoString=cachedCtrs.Number.prototype.toString,toUpperCase=cachedCtrs.String.prototype.toUpperCase;module.exports=function intToRGB(i){return"#"+toUpperCase.call(padStart(numbertoString.call(toUint24(i),16),6,"0"))}},{"cached-constructors-x":3,"string-pad-start-x":25,"to-uint-24-x":33}],2:[function(_dereq_,module,exports){/**
 ...
 * @module modulo-x
 */
"use strict";module.exports=function modulo(dividend,divisor){var remain=dividend%divisor;return Math.floor(remain>=0?remain:remain+divisor)}},{}],19:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":24,"to-string-x":32}],24:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var libToInteger=_dereq_("to-integer-x"),toInteger2016=libToInteger.toInteger2016,toInteger2018=libToInteger.toInteger2018,MAX_SAFE_INTEGER=_dereq_("max-safe-integer"),$toLength2018=function toLength2018(value){var len=toInteger2018(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len};module.exports={toLength:$toLength2018,toLength2016:function toLength2016(value){var len=toInteger2016(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len},toLength2018:$toLength2018}},{"max-safe-integer":17,"to-integer-x":27}],29:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr={}.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":15,"validate.io-undefined":37}],32:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":14}],33:[function(_dereq_,module,exports){/**
 ...
 * @module to-uint-24-x
 */
"use strict";var toNumber=_dereq_("to-number-x").toNumber2018,modulo=_dereq_("modulo-x"),sign=_dereq_("math-sign-x").sign2018,numberIsFinite=_dereq_("is-finite-x"),floor=Math.floor,abs=Math.abs;module.exports=function toUint24(argument){var number=toNumber(argument);return 0===number||!1===numberIsFinite(number)?0:modulo(sign(number)*floor(abs(number)),16777216)}},{"is-finite-x":9,"math-sign-x":16,"modulo-x":18,"to-number-x":29}],34:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":23,"white-space-x":38}],36:[function(_dereq_,module,exports){/**
